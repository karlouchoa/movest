...
def extrair_movimentacoes_novas(
    ...
    SELECT t.codtransf as numdoc, t.datahorarec as data,
           ...
           ISNULL(t.cdempsaida, 1) as clifor, 1 as empfor, ISNULL(it.empitem, 1) as empitem,
    ...
    SELECT t.codtransf as numdoc, t.datahorarec as data,
           ...
           ISNULL(t.cdempentrada, 1) as clifor, 1 as empfor, ISNULL(it.empitem, 1) as empitem,
           t.observacao as obs, CAST(t.observacao AS VARCHAR(255)) as obsit, t.codusu_transf as codusu,
           CAST(t.codusu_rec AS VARCHAR(50)) as ip, t.cdempsaida as empven,
           CAST(0 AS DECIMAL(18, 4)) as Preco,
           CAST(0 AS DECIMAL(18, 4)) as valor,
