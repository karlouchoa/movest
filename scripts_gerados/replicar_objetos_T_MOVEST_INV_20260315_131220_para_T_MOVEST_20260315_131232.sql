-- Origem: dbo.T_MOVEST_INV_20260315_131220
-- Destino: dbo.T_MOVEST
-- Gerado em: 2026-03-15T13:12:32.417370
...
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_131220] DROP CONSTRAINT [PK_t_movest_final]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_131220] DROP CONSTRAINT [DF_t_movest_createdat]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_131220] DROP CONSTRAINT [DF_t_movest_isdeleted]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_131220] DROP CONSTRAINT [DF_t_movest_updatedat]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_131220] DROP CONSTRAINT [DF_t_movest_data]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_131220] DROP CONSTRAINT [DF_t_movest_datadoc]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_131220] DROP CONSTRAINT [DF_t_movest_DataLan]
GO
