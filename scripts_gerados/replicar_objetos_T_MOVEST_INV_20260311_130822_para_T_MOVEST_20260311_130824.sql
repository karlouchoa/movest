-- Origem: dbo.T_MOVEST_INV_20260311_130822
-- Destino: dbo.T_MOVEST
-- Gerado em: 2026-03-11T13:08:24.568964
...
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_130822] DROP CONSTRAINT [PK_t_movest_final]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_130822] DROP CONSTRAINT [DF_t_movest_createdat]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_130822] DROP CONSTRAINT [DF_t_movest_data]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_130822] DROP CONSTRAINT [DF_t_movest_datadoc]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_130822] DROP CONSTRAINT [DF_t_movest_DataLan]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_130822] DROP CONSTRAINT [DF_t_movest_isdeleted]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_130822] DROP CONSTRAINT [DF_t_movest_updatedat]
GO
