-- Origem: dbo.T_MOVEST_INV_20260314_010053
-- Destino: dbo.T_MOVEST
-- Gerado em: 2026-03-14T01:01:08.617708
...
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_010053] DROP CONSTRAINT [PK_T_MOVEST_final]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_010053] DROP CONSTRAINT [DF_T_MOVEST_DataLan]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_010053] DROP CONSTRAINT [DF_t_movest_createdat]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_010053] DROP CONSTRAINT [DF_t_movest_isdeleted]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_010053] DROP CONSTRAINT [DF_t_movest_updatedat]
GO
DROP INDEX [IX_T_MOVEST_2] ON dbo.[T_MOVEST_INV_20260314_010053]
GO
DROP INDEX [IX_T_MOVEST_3] ON dbo.[T_MOVEST_INV_20260314_010053]
GO
