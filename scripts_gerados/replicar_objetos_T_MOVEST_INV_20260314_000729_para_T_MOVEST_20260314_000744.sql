-- Origem: dbo.T_MOVEST_INV_20260314_000729
-- Destino: dbo.T_MOVEST
-- Gerado em: 2026-03-14T00:07:44.063925
...
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_000729] DROP CONSTRAINT [PK_T_MOVEST]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_000729] DROP CONSTRAINT [DF_t_movest_DataLan]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_000729] DROP CONSTRAINT [DF_t_movest_isdeleted]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_000729] DROP CONSTRAINT [DF_t_movest_updatedat]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_000729] DROP CONSTRAINT [DF_t_movest_createdat]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_000729] DROP CONSTRAINT [DF_t_movest_data]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260314_000729] DROP CONSTRAINT [DF_t_movest_datadoc]
GO
DROP INDEX [IX_T_MOVEST] ON dbo.[T_MOVEST_INV_20260314_000729]
GO
DROP INDEX [IX_T_MOVEST_1] ON dbo.[T_MOVEST_INV_20260314_000729]
GO
DROP INDEX [IX_T_MOVEST_2] ON dbo.[T_MOVEST_INV_20260314_000729]
GO
DROP INDEX [IX_T_MOVEST_3] ON dbo.[T_MOVEST_INV_20260314_000729]
GO
DROP INDEX [IX_T_MOVEST_4] ON dbo.[T_MOVEST_INV_20260314_000729]
GO
