-- Origem: dbo.T_MOVEST_INV_20260315_134743
-- Destino: dbo.T_MOVEST
-- Gerado em: 2026-03-15T13:47:55.399475
...
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_134743] DROP CONSTRAINT [PK_t_movest_final]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_134743] DROP CONSTRAINT [DF_t_movest_createdat]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_134743] DROP CONSTRAINT [DF_t_movest_updatedat]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_134743] DROP CONSTRAINT [DF_t_movest_DataLan]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_134743] DROP CONSTRAINT [DF_t_movest_isdeleted]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_134743] DROP CONSTRAINT [DF_t_movest_data]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260315_134743] DROP CONSTRAINT [DF_t_movest_datadoc]
GO
DROP INDEX [IX_t_movest] ON dbo.[T_MOVEST_INV_20260315_134743]
GO
DROP INDEX [IX_t_movest_1] ON dbo.[T_MOVEST_INV_20260315_134743]
GO
