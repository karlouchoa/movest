-- Origem: dbo.T_MOVEST_INV_20260311_152354
-- Destino: dbo.T_MOVEST
-- Gerado em: 2026-03-11T15:24:05.015622
...
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_152354] DROP CONSTRAINT [PK_t_movest_final]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_152354] DROP CONSTRAINT [DF_t_movest_createdat]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_152354] DROP CONSTRAINT [DF_t_movest_data]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_152354] DROP CONSTRAINT [DF_t_movest_datadoc]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_152354] DROP CONSTRAINT [DF_t_movest_DataLan]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_152354] DROP CONSTRAINT [DF_t_movest_isdeleted]
GO
ALTER TABLE dbo.[T_MOVEST_INV_20260311_152354] DROP CONSTRAINT [DF_t_movest_updatedat]
GO
